package com.jaredblack.counter.controllers;
...
//		Can use the following line to get the URL of our page, in this case http://localhost:8080/counter/
		
		String homeUrl = request.getRequestURL().toString();
		model.addAttribute("count", currentCount);
//		Removes the last nine characters from homeUrl to match the desired wireframe out
//		http://localhost:8080 instead of http://localhost:8080/counter/
